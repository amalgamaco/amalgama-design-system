...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "relative flex cursor-pointer select-none items-center gap-2 rounded-md px-3 py-2 text-sm outline-none transition-colors [&_svg]:size-[18px] [&_svg]:shrink-0 [&_svg]:opacity-70",
