    ...
    <div ref={ref} className={cn(toastVariants({ variant, className }))} {...props}>
      ...
      {onClose && (
        <button
          type="button"
          onClick={onClose}
          className="w-6 h-6 border-none bg-transparent inline-flex items-center justify-center cursor-pointer text-on-surface-variant rounded-sm transition-[background,color] duration-fast ease-default hover:bg-surface-variant hover:text-on-surface focus-visible:focus-ring"
        >
