...
>(({ className, ...props }, ref) => (
  <RadioGroupPrimitive.Item
    ref={ref}
    className={cn(
      "aspect-square size-5 rounded-full border-2 border-outline text-primary transition-colors duration-fast ease-default align-middle aria-invalid:border-error",
