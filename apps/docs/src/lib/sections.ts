...
export const COMPONENT_SECTIONS: SectionMeta[] = [
  ...
  { id: 'checkbox', title: 'Checkbox', category: 'Selección', path: '/components/checkbox', status: 'todo' },
  { id: 'radio', title: 'Radio', category: 'Selección', path: '/components/radio', status: 'todo' },
  { id: 'input', title: 'Text field', category: 'Inputs', path: '/components/input', status: 'todo' },
  { id: 'badge', title: 'Badge', category: 'Display', path: '/components/badge', status: 'todo' },
  { id: 'tabs', title: 'Tabs', category: 'Navigation', path: '/components/tabs', status: 'todo' },
  { id: 'dialog', title: 'Dialog', category: 'Overlays', path: '/components/dialog', status: 'todo' },
  { id: 'tooltip', title: 'Tooltip', category: 'Overlays', path: '/components/tooltip', status: 'todo' },
