...
tokens:
  color: [--surface, --on-surface, --scrim]
  radius: [--radius-lg]
...
motion:
  ...
  stateChange: "modal-close button hover: background→--surface-variant, color→--on-surface; focus-visible ring (2px --focus + 4px --focus-ring)."
