...
45 de 335 tokens no se copian tal cual. El valor sigue siendo el mismo — cambia como se aplica.
...
| `--line-height-body-editorial` | `1.875` | `multiplicador` | RN mide lineHeight en puntos: lineHeight = fontSize * 1.875 |
